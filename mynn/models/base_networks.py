...
class DeconvBlock(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.deconv = torch.nn.ConvTranspose2d(input_size,
                                               output_size,
                                               kernel_size,
                                               stride,
                                               padding,
...
class D_UpBlock(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.conv = ConvBlock(num_filter * num_stages,
                              num_filter,
                              1,
                              1,
                              0,
...
class DownBlock(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.down_conv1 = ConvBlock(num_filter,
                                    num_filter,
                                    kernel_size,
                                    stride,
                                    padding,
                                    activation,
                                    norm=None)
        self.down_conv2 = DeconvBlock(num_filter,
                                      num_filter,
                                      kernel_size,
                                      stride,
                                      padding,
                                      activation,
                                      norm=None)
        self.down_conv3 = ConvBlock(num_filter,
                                    num_filter,
                                    kernel_size,
                                    stride,
                                    padding,
...
class Upsample2xBlock(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if upsample == 'deconv':
            self.upsample = DeconvBlock(input_size,
                                        output_size,
                                        kernel_size=4,
                                        stride=2,
                                        padding=1,
        ...
        # 2. Sub-pixel convolution (Pixel shuffler)
            ...
            self.upsample = PSBlock(input_size,
                                    output_size,
